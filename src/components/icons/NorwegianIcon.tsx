...
interface NorwegianIconProps {
  width?: number;
  height?: number;
}

const NorwegianIcon: React.FC<NorwegianIconProps> = ({ width = 28, height = 20 }) => {
  const svgXml = `
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M0 10.6667H9.33333V20H10.6667V10.6667H28V9.33333H10.6667V0H9.33333V9.33333H0V10.6667Z" fill="url(#paint3_linear_1310_7527)"/>
  </g>
  <defs>
